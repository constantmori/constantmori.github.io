(function() {
    ...
    function rendererer(complete) {
        ...
        //material settings
        spriteOpts = {
            color: 0x484847, // 7fffd4, 6a6a71, 2d2d2e,  ball color
						opacity: 0.95, // new
        ...
        renderer = new THREE.CanvasRenderer(
					{ alpha: true } // alpha + 000000 = bg transparency
				);
        renderer.setClearColor(0x85fa47,0); 
            // (0x000000,0) (0xf6780a,1) background color
