...
(function () {
	...
	e.defaults = {
		global: {
			animation: !0
			, animationSteps: 5 // 60, 0 = fast; +1 = slower
			...
			, scaleFontColor: "#666"
			, responsive: true // !1
			, maintainAspectRatio: true // !0
			, showTooltips: true // !0 popup data
			, customTooltips: true // !1
			, tooltipEvents: ["mousemove", "touchstart", "touchmove", "mouseout"]
			, tooltipFillColor: "rgba(0,0,0,0.5)"
			, tooltipFontFamily: "'Century Gothic', 'Brandon Grotesque', 'Gill Sans', sans-serif"
			//"'Helvetica Neue', 'Helvetica', 'Arial', sans-serif"
			, tooltipFontSize: 12
			, tooltipFontStyle: "normal"
			, tooltipFontColor: "rgba(245, 245, 245, 1)"
			, tooltipTitleFontFamily: "Century Gothic', 'Brandon Grotesque', 'Gill Sans', sans-serif"
			//"'Helvetica Neue', 'Helvetica', 'Arial', sans-serif"
			, tooltipTitleFontSize: 12
			, tooltipTitleFontStyle: "normal"
			, tooltipTitleFontColor: "rgba(245, 245, 245, 1)"
			, tooltipYPadding: 6
			, tooltipXPadding: 6
			, tooltipCaretSize: 8
			, tooltipCornerRadius: 0.5
			, tooltipXOffset: 10
			, tooltipTemplate: "<%if (label){%><%=label%>: <%}%><%= value %>"
			, multiTooltipTemplate: "<%= value %>"
			, multiTooltipKeyBackground: "rgba(245, 245, 245, 1)"
	...
	, function () {
		...
		i.Type.extend({
			...
			, defaults: {
				...
				, angleLineWidth: 1
				, pointLabelFontFamily: "'Century Gothic', 'Brandon Grotesque', 'Gill Sans', sans-serif"
				//"'Arial'"
				, pointLabelFontStyle: "normal"
				, pointLabelFontSize: 10
				, pointLabelFontColor: "rgba(245, 245, 245, 0.97)"
				, pointDot: !0
				, pointDotRadius: 3
				, pointDotStrokeWidth: 0.01 // 1
				, pointHitDetectionRadius: 20
				, datasetStroke: !0
				, datasetStrokeWidth: 0.5 // 2
				, datasetFill: !0
				, legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (var i=0; i<datasets.length; i++){%><li><span style="background-color:<%=datasets[i].strokeColor%>"></span><%if(datasets[i].label){%><%=datasets[i].label%><%}%></li><%}%></ul>'
			}
			, initialize: function (t) {
